...
<html lang="fr">
        ...
        <div class="container">
            <header class="pt-4 pb-4 d-flex flex-wrap align-items-center justify-content-center  justify-content-md-between">
                <a class="d-flex align-items-center col-md-3 mb-2 mb-md-0" href="accueil.php"><img width="270" height="100" src="../assets/images/logo_fomme_fleurs_270x100px.png" alt=""></a>
                ...
                <div class="col-md-3 text-end">
                    <a class="me-2" href="connexion"><button class='btn btn-outline-primary'>Login</button></a><a href="user"><button class='btn btn-primary'>Sign-up</button></a></div>
                ...
                <?php
                    ...
                    <div class="dropdown col-md-3 text-end">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="produit">Consulter les produits</a></li>
                            </ul>
                            </div>
                        <?php }
                        ?>
                         <a href="connexion.php"><button class='btn btn-warning'>Logout</button></a>
                         <?php
                        }else{
            ...
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
                <div class="col-md-4 d-flex align-items-center">
                    <a class="mb-3 me-2 md-md-0 text-muted text-decoration-none lh-1" href="/">
                        <img src="../assets/images/pot_de_fleur.png" alt="" width="30" height="24">
                    </a>
