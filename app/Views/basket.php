                    ...
                    <div class="card card-registration card-registration-2" style="border-radius: 15px;">
                        <div class="card-body p-0">
                            <div class="row g-0">
                                ...
                                <div class="col-log-4 bg-grey">
                                    <div class="p-5">
                                        <h3 class="fw-bold md-5 mt-2 pt-1">Récapitulatif</h3>
                                        <hr class="my-4">
                                        ...
                                        <button type="button" class="btn btn-dark btn-block btn-lg" data-mdb-ripple-color="dark">Passer à l'étape suivante</button>
                                    </div>
                                </div>
            </div>
            </div>
